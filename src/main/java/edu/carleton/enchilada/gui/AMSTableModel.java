...
public class AMSTableModel extends AbstractTableModel implements TableModelListener{
	...
	public AMSTableModel() {
		super();
			...
			columnNames[0] = "#";
			columnNames[1] = "dataset";
			columnNames[2] = "timeseries"; 
			columnNames[3] = "masstocharge";
