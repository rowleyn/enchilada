...
/**
 * Standard importation table for PKL data files.
 * One column for .txt and varying row length
 * 
 * @author PKL importer modified by Michael Murphy 2014
 *
 */
public class PKLTableModel extends AbstractTableModel implements TableModelListener{
	...
	public PKLTableModel() {
		super();
			...
			columnNames[0] = "#";
			columnNames[1] = "PKL File";
			
			newColumn.add(new Integer(++setCount));
			newColumn.add(new String(".pkl file"));
