...
/**
 * Standard importation table for SPASS data files.
 * One column for .txt and varying row length
 * 
 * @author rzeszotj with credit to other table model authors
 *
 */
public class SPASSTableModel extends AbstractTableModel implements TableModelListener{
